...
const Home: FC = () => {
  return (
    <Layout title="API Collection" icon="/favicon.ico" description="guole.fun API Collection" keywords="API,接口,免费API,公共API,API集合">
      <main className="home">
        ...
        <div className="control">
          <button id="all-button" title="接口列表">
          ...
          <button id="test-button" title="随机测试">
          ...
          <button id="docs-button" title="接口文档">
