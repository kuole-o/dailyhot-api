...
const Error: FC = (props) => {
  return (
    <Layout title="Error | API Collection" icon="/error.ico" description="程序执行出错" keywords="Error,程序执行出错">
      <main className="error">
        ...
        <div class="control">
          <button id="reload-button" title="刷新重试">
            <svg
              className="btn-icon"
          ...
          <button id="home-button" title="回到首页">
            <svg
              className="btn-icon"
              xmlns="http://www.w3.org/2000/svg"
              width="32"
